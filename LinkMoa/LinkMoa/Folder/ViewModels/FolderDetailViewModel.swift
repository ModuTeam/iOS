...
final class FolderDetailViewModel: FolderDetailViewModelOutputs, FolderDetailViewModelInputs, FolderDetailViewModelType {
    ...
    var folderDetail: Observable<FolderDetail.Result> = Observable(FolderDetail.Result(userIndex: -1, name: "-1", type: "-1", linkCount: 0, hashTagList: [], linkList: []))
    ...
    func fetchFolderDetail(folderIndex index: Int) {
        surfingManager.fetchFolderDetail(folder: index, completion: { [weak self] result in
